...
int main(void) {
    try {
        ...
        while (true) {
            ...
            fprintf(stdout, "%s", "*** Input server address for connect ***\n");
            ...
            if (get_string != "") {
                //restful_test->restful_c_open("http://127.0.0.1:9090");
                restful_test->restful_c_open(get_string);
